...
-define(MAIN,'main@192.168.1.102').
-define(N,424).
-define(M,944).
-define(W,28).
-define(H,39).
-define(SMELL_R,150).
-define(PC1,'pc1@192.168.1.103').
-define(PC2,'pc2@192.168.1.104').
-define(PC3,'pc3@192.168.1.105').
-define(PC4,'pc4@192.168.1.106').
...
checkSmell(X,Y)->
	...
	case qlc:eval(QH) of
		[{XSmell,YSmell}|_T]-> case {{X,Y},{XSmell,YSmell}} of 
